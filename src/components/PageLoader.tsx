...
export const PageLoader: React.FC<PageLoaderProps> = ({
  ...
  return (
    <div
      className={`fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#0a0a0a] transition-all duration-600 ${
      ...
      >
        ...
        >
          ...
          <div 
            ...
            style={{
              width: `${progress}%`,
              background: 'linear-gradient(90deg, #00E13C 0%, #00E13C 100%)',
            }}
          />
        </div>
