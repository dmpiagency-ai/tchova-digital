...
const ServiceDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <main className="container relative z-10 mx-auto px-4 py-6 max-w-5xl">
        <div className="mb-6">
          <Button
            variant="ghost"
            onClick={() => navigate(-1)}
          ...
          <div className="tech-card overflow-hidden mb-8 sm:mb-12 lg:mb-20 rounded-[24px] sm:rounded-[32px] lg:rounded-[48px] shadow-xl border border-primary/20 relative">
            ...
            <div className="relative p-4 sm:p-6 lg:p-8">
              ...
              <div className="sm:hidden space-y-4">
                ...
                <div className="bg-brand-dark/90 backdrop-blur-md rounded-2xl p-5 border border-white/20 animate-fade-in">
                  <h1 className="text-2xl font-bold text-white mb-2 leading-tight">
                    <span className="bg-gradient-to-r from-primary via-brand-bright to-brand-yellow bg-clip-text text-transparent">
                      Serviços GSM
                    </span>
                  </h1>
                ...
                {/* Bento Grid 2x3 - Ferramentas */}
                <div className="grid grid-cols-3 gap-3">
                  {/* Card 1 - Chimera */}
                  <div
                    className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-lg p-4 flex flex-col items-center justify-center aspect-square border border-primary/30 transform transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] cursor-pointer animate-fade-in group"
                    style={{ animationDelay: '0.1s' }}
                  >
                    <div className="w-14 h-14 bg-gradient-to-br from-primary to-primary-darker rounded-xl flex items-center justify-center mb-2 shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <Box className="w-7 h-7 text-white" />
                    </div>
                    <span className="text-xs font-bold text-gray-800 text-center">Chimera</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Tool</span>
                  </div>
                  
                  {/* Card 2 - UnlockTool */}
                  <div
                    className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-lg p-4 flex flex-col items-center justify-center aspect-square border border-brand-green/30 transform transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] cursor-pointer animate-fade-in group"
                    style={{ animationDelay: '0.15s' }}
                  >
                    <div className="w-14 h-14 bg-gradient-to-br from-brand-green to-primary rounded-xl flex items-center justify-center mb-2 shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <Lock className="w-7 h-7 text-white" />
                    </div>
                    <span className="text-xs font-bold text-gray-800 text-center">Unlock</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Tool</span>
                  </div>
                  
                  {/* Card 3 - TCM */}
                  <div
                    className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-lg p-4 flex flex-col items-center justify-center aspect-square border border-brand-yellow/30 transform transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] cursor-pointer animate-fade-in group"
                    style={{ animationDelay: '0.2s' }}
                  >
                    <div className="w-14 h-14 bg-gradient-to-br from-brand-yellow to-accent-light rounded-xl flex items-center justify-center mb-2 shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <Activity className="w-7 h-7 text-white" />
                    </div>
                    <span className="text-xs font-bold text-gray-800 text-center">TCM</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Tool</span>
                  </div>
                  
                  {/* Card 4 - EFT */}
                  <div
                    className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-lg p-4 flex flex-col items-center justify-center aspect-square border border-brand-bright/30 transform transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] cursor-pointer animate-fade-in group"
                    style={{ animationDelay: '0.25s' }}
                  >
                    <div className="w-14 h-14 bg-gradient-to-br from-brand-bright to-brand-green rounded-xl flex items-center justify-center mb-2 shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <Zap className="w-7 h-7 text-white" />
                    </div>
                    <span className="text-xs font-bold text-gray-800 text-center">EFT</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Pro</span>
                  </div>
                  ...
                  >
                    <div className="w-14 h-14 bg-gradient-to-br from-primary to-brand-green rounded-xl flex items-center justify-center mb-2 shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <RefreshCw className="w-7 h-7 text-white" />
                    </div>
                    <span className="text-xs font-bold text-gray-800 text-center">Hydra</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Tool</span>
                  </div>
                  
                  {/* Card 6 - UMT */}
                  <div
                    className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-lg p-4 flex flex-col items-center justify-center aspect-square border border-brand-dark/30 transform transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] cursor-pointer animate-fade-in group"
                    style={{ animationDelay: '0.35s' }}
                  >
                    <div className="w-14 h-14 bg-gradient-to-br from-brand-dark to-brand-dark rounded-xl flex items-center justify-center mb-2 shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <Smartphone className="w-7 h-7 text-white" />
                    </div>
                    <span className="text-xs font-bold text-gray-800 text-center">UMT</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Pro</span>
                  </div>
                </div>
                ...
                <Button
                  ...
                  className="w-full rounded-2xl py-3 px-6 font-bold transition-all duration-400 bg-gradient-to-r from-primary to-brand-green hover:from-primary-darker hover:to-brand-green text-white shadow-xl hover:shadow-2xl transform hover:scale-[1.02] active:scale-[0.98] h-12 text-sm relative overflow-hidden group animate-fade-in"
                  style={{ animationDelay: '0.3s' }}
                >
                  ...
                  <svg viewBox="0 0 24 24" className="w-5 h-5 mr-2 relative z-10 group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <div className="sm:hidden space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Logotipos</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Identidade</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Cartões</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Com QR</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Social Media</span>
                  ...
                  <div
                    ...
                    style={{ animationDelay: '0.25s' }}
                  >
                    <div className="w-14 h-14 bg-gradient-to-br from-brand-green to-brand-green rounded-xl flex items-center justify-center mb-2 shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <FileImage className="w-7 h-7 text-white" />
                    </div>
                    <span className="text-xs font-bold text-gray-800 text-center">Banners</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Flyers</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Ads</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Publicidade</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Motion</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Vídeo</span>
                  </div>
                </div>
                ...
                <Button
                  ...
                  className="w-full rounded-2xl py-3 px-6 font-bold transition-all duration-400 bg-gradient-to-r from-primary to-primary-darker hover:from-[primary-dark] hover:to-primary-darker text-white shadow-xl hover:shadow-2xl transform hover:scale-[1.02] active:scale-[0.98] h-12 text-sm relative overflow-hidden group animate-fade-in"
                  style={{ animationDelay: '0.3s' }}
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/10 to-white/0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-in-out"></div>
                  <svg viewBox="0 0 24 24" className="w-5 h-5 mr-2 relative z-10 group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <div className="sm:hidden space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Institucional</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Empresa</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Landing</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Page</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">100%</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Responsivo</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">WhatsApp</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Integrado</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">SEO</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Otimizado</span>
                  </div>
                  
                  {/* Card 6 - Velocidade */}
                  <div
                    className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-lg p-4 flex flex-col items-center justify-center aspect-square border border-accent/30 transform transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] cursor-pointer animate-fade-in group"
                    style={{ animationDelay: '0.35s' }}
                  >
                    <div className="w-14 h-14 bg-gradient-to-br from-accent to-brand-yellow rounded-xl flex items-center justify-center mb-2 shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <Zap className="w-7 h-7 text-white" />
                    </div>
                    <span className="text-xs font-bold text-gray-800 text-center">Rápido</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Veloz</span>
                  </div>
                </div>
              ...
              <div className="sm:hidden space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Filmagem</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Vídeo</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Foto</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Sessão</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Edição</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Premium</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Drone</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Aéreo</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Fogo</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Artifício</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Fumaça</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Bolas</span>
                  </div>
                </div>
              ...
              <div className="sm:hidden space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Redes</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Sociais</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Conteúdo</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Criativo</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Anúncios</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Pagos</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Estratégia</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Digital</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Relatórios</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Análise</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Clientes</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Reais</span>
                  </div>
                </div>
                ...
                <Button
                  ...
                  className="w-full rounded-2xl py-3 px-6 font-bold transition-all duration-400 bg-gradient-to-r from-brand-yellow to-primary hover:from-accent-light hover:to-primary-darker text-white shadow-xl hover:shadow-2xl transform hover:scale-[1.02] active:scale-[0.98] h-12 text-sm relative overflow-hidden group animate-fade-in"
                  style={{ animationDelay: '0.3s' }}
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/10 to-white/0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-in-out"></div>
                  <svg viewBox="0 0 24 24" className="w-5 h-5 mr-2 relative z-10 group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <div className="sm:hidden space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">100%</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Seguro</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Tracking</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Privado</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Global</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">China, EUA</span>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-gray-800 text-center">Suporte</span>
                    <span className="text-[10px] text-gray-500 mt-0.5">Humano</span>
                  </div>
                </div>
        ...
        {isGSM && (
          <>
            ...
            {/* Processo - 5 Etapas - Mobile First */}
